    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.summaryGrid}>
          <ReportStat label="Collected" value={`₹${totalCollected}`} icon="cash-check" color={SUCCESS} />
          <ReportStat label="Later Amount" value={`₹${laterTotal}`} icon="clock-outline" color="#F4511E" />
          <ReportStat label="Cash Count" value={cashCount} icon="hand-coin-outline" color="#8D6E63" />
          <ReportStat label="UPI Count" value={upiCount} icon="cellphone-arrow-down" color={PRIMARY} />
        </View>
...
const styles = StyleSheet.create({
  ...
  reportStat: { width: '46%', backgroundColor: '#fff', padding: 15, borderRadius: 20, alignItems: 'center' },
